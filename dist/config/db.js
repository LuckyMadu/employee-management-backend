...
var connectDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    var connectionURI, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                connectionURI = "".concat(process.env.DB_PREFIX, "://").concat(process.env.DB_USERNAME, ":").concat(process.env.DB_PASSWORD, "@").concat(process.env.DB_HOST, "/").concat(process.env.DB_DATABASE, "?retryWrites=true&w=majority");
